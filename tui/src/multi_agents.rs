...
pub fn spawn_end(ev: CollabAgentSpawnEndEvent) -> PlainHistoryCell {
...
pub fn interaction_end(ev: CollabAgentInteractionEndEvent) -> PlainHistoryCell {
...
pub fn waiting_begin(ev: CollabWaitingBeginEvent) -> PlainHistoryCell {
...
pub fn waiting_end(ev: CollabWaitingEndEvent) -> PlainHistoryCell {
...
pub fn close_end(ev: CollabCloseEndEvent) -> PlainHistoryCell {
...
pub fn resume_begin(ev: CollabResumeBeginEvent) -> PlainHistoryCell {
...
pub fn resume_end(ev: CollabResumeEndEvent) -> PlainHistoryCell {
