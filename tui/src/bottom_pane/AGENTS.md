...
- Update the narrative doc `docs/wiki/tui-chat-composer.md` whenever behavior/assumptions change (Enter
  handling, retro-capture, flush/clear rules, `disable_paste_burst`, non-ASCII/IME handling).
- Keep this folder aligned with upstream Codex TUI (`../codex/codex-rs/tui/src/bottom_pane`)
  unless the divergence is intentional and documented in `tui/AGENTS.md` (and in code doc comments
  near the relevant implementation).
